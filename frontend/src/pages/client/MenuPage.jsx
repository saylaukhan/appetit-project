...
function MenuPage() {
  ...
  const createPlaceholderImage = () => {
    const svg = `
      <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
        ...
        <circle cx="150" cy="120" r="35" fill="#dee2e6"/>
        <rect x="100" y="180" width="100" height="12" fill="#dee2e6" rx="6"/>
        <rect x="115" y="205" width="70" height="8" fill="#dee2e6" rx="4"/>
        <text x="150" y="240" font-family="Arial, sans-serif" font-size="14" fill="#6c757d" text-anchor="middle">Изображение не найдено</text>
        <text x="150" y="260" font-family="Arial, sans-serif" font-size="12" fill="#6c757d" text-anchor="middle">300 × 300</text>
      </svg>
    `
